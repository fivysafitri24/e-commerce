          ...
          <div class="row">
              ...
              <div class="product__details__pic">
                <div class="product__details__pic__item">
                  <img
                    ...
                    src="{{ asset('frontend/img/product/details/product-details-1.png') }}"
                    alt=""
                  />
                </div>
            ...
            <div class="col-lg-6 col-md-6">
              <div class="product__details__text">
                ...
                <div class="product__details__price">Rp 210.000</div>
                <p>
                  Paket raya 1 ini berisi 4 toples kue kering yaitu kue nastar, kue kastangel, 
                            kue putri salju, dan kue semprit. Untuk rasa tidak perlu diragukan lagi. Pembelian 
                            Paket raya 1 ini akan mendapat gift lebaran dari kami. Yuk checkout sekarang sebelum kehabisan!
                </p>
